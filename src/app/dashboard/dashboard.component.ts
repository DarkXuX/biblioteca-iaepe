...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  loadKpis(): void {
    // Aquí iría la carga real de datos (por ahora, mock data)
    this.dashboardService.getKpis().subscribe((data) => {
      this.kpiData = data;
    });
  }

  onExportRequest(exportType: string): void {
    console.log(`Exportación solicitada para: ${exportType}`);
    // **PENDIENTE:** Implementar la lógica que obtiene los datos detallados
    // y los exporta a Excel/Google Sheets (como lo requiere el POA).
    alert(`Preparando el informe detallado de ${exportType} para descarga.`);
  }
