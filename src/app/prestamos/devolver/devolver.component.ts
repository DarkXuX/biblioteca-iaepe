...
@Component({
  selector: "app-devolver-cmp",
  templateUrl: "./devolver.component.html",
})
export class DevolverComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    const table = $("#datatablesDevolver").DataTable();
